...
INPUT_CONTEXT_MANAGER_NAME = os.getenv("INPUT_CONTEXT_MANAGER", DEFAULT_INPUT_CONTEXT_MANAGER_NAME).strip()
...
OUTPUT_CONTEXT_MANAGER_NAME = os.getenv("OUTPUT_CONTEXT_MANAGER", DEFAULT_OUTPUT_CONTEXT_MANAGER_NAME).strip()
...
logger.info(f"REQUEST_S3URI_KEYS={REQUEST_S3URI_KEYS}")
...
DYNAMODB_REQUESTS_TABLE_HASHKEY_KEYNAME = os.getenv("REQUESTS_TABLE_HASHKEY_KEYNAME", "job_id")

# fields dependent on api implementation
DYNAMODB_RESULTS_TABLE_STATE_FIELDNAME = "predictor_status"
