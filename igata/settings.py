...
DEFAULT_INPUT_CSV_HEADER_LINES = "0"  # a header may span more than 1 line
INPUT_CSV_HEADER_LINES = int(os.getenv("INPUT_CSV_HEADER_LINES", DEFAULT_INPUT_CSV_HEADER_LINES))
